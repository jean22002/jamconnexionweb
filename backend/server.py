...
# Build 95.13 — Alias pluriel /webhooks/stripe (demande agent mobile)
from routes.webhooks import router_plural as webhooks_router_plural
api_router.include_router(webhooks_router_plural)
