...
import { Check, Crown, TrendingUp, FileText, BarChart3, Loader2, Sparkles, ChevronDown, ChevronUp, AlertCircle, Camera, Music, MapPin, Users, Filter, Settings } from 'lucide-react';
    ...
    <div className="mb-6">
      ...
      {profile?.tier === 'pro' || profile?.subscription_status === 'active' ? (
        <div className="space-y-3">
          <Button
            onClick={() => window.open('https://billing.stripe.com/p/login/28E7sKfFj7peek49XjafS00', '_blank')}
          ...
          <p className="text-xs text-center text-muted-foreground">
            Modifier, annuler ou mettre à jour votre abonnement
          </p>
        </div>
      ) : (
        <Button
