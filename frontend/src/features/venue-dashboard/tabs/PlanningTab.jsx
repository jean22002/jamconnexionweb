...
export default function PlanningTab({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Build 152.27 — Modal des candidatures + convert-to-concert extraites vers
          <ApplicationsModal /> monté au niveau du VenueDashboard afin qu'elles fonctionnent
          depuis n'importe quel onglet (Planning, Candidatures, etc.). */}
    </div>
  );
}
