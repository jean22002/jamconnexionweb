      ...
      <div className="max-w-2xl w-full">
        <div className="glassmorphism rounded-3xl p-8 md:p-12 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Pour continuer sur Jam Connexion, choisis un abonnement mensuel à 9,99€/mois (sans engagement).
          </p>
          ...
          <div className="glassmorphism rounded-2xl p-6 mb-8 neon-border">
            <div className="flex items-baseline justify-center gap-2 mb-2">
              <span className="font-heading font-bold text-5xl text-gradient">9,99€</span>
