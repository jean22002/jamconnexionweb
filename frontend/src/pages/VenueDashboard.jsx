...
export default function VenueDashboard() {
  ...
  const [karaokeForm, setKaraokeForm] = useState({
    ...
    conditions: "", // NOUVEAU : Conditions (animateur, DJ, matériel, etc.)
    price: "", // NOUVEAU : Tarif/Prix d'entrée
    ...
    <div className="min-h-screen bg-background" data-testid="venue-dashboard">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <EventDetailsDialog
          ...
          bandSuggestions={bandSuggestions}
          showBandSuggestions={showBandSuggestions}
          setShowBandSuggestions={setShowBandSuggestions}
          handleDeleteEvent={handleDeleteEvent}
