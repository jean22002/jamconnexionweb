...
if __name__ == "__main__":
    ...
    ------
    # Run with Web UI:
    locust -f locust_load_test.py --host=https://collapsible-map.preview.emergentagent.com
    
    # Run headless with specific user count:
    locust -f locust_load_test.py --host=https://collapsible-map.preview.emergentagent.com --headless -u 100 -r 10 --run-time 2m
    
    # High load test (1000 users):
    locust -f locust_load_test.py --host=https://collapsible-map.preview.emergentagent.com --headless -u 1000 -r 50 --run-time 3m --only-summary
