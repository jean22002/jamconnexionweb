...
- **URL**: https://production-bugfix-1.preview.emergentagent.com
- **Email**: bar@gmail.com
- **Password**: test  
- **Role**: venue (verified)
...
- **Backend URL**: https://production-bugfix-1.preview.emergentagent.com/api
...
- **URL**: https://production-bugfix-1.preview.emergentagent.com/login
...
- **Requested URL**: https://production-bugfix-1.preview.emergentagent.com - **Status: "Preview Unavailable!!!" (Agent sleeping)**
- **Alternative URL**: https://production-bugfix-1.preview.emergentagent.com - **Status: Authentication/Access Issues**
...
1. **Environment Unavailability:**
   - ❌ Requested URL: https://production-bugfix-1.preview.emergentagent.com completely down
   - ❌ Alternative URL: https://production-bugfix-1.preview.emergentagent.com has auth issues
...
1. Test environment (https://production-bugfix-1.preview.emergentagent.com) is available
...
- **Requested URL**: https://production-bugfix-1.preview.emergentagent.com - **Status: "Preview Unavailable!!!" (Agent sleeping)**
- **Alternative URL**: https://production-bugfix-1.preview.emergentagent.com - ✅ Available
...
1. ❌ **Original URL unavailable**: https://production-bugfix-1.preview.emergentagent.com is down (agent sleeping)
...
**The feature WILL work correctly when:**
1. Testing environment https://production-bugfix-1.preview.emergentagent.com is available
...
- Page URL: `https://production-bugfix-1.preview.emergentagent.com/venue`
...
**Network Monitoring:**
- Request URL: `https://production-bugfix-1.preview.emergentagent.com/api/invoices/concert-test-0_9ad105ca.png`
- Request Method: GET
- Response Status: 200 OK
- Response Type: blob (binary data)

**Download Mechanism:**
- Blob URL created: `blob:https://production-bugfix-1.preview.emergentagent.com/bcc727b7-ee1c-4d18-bb25-762a72ee4eda`
...
### Test Environment
- **URL Attempted:** https://production-bugfix-1.preview.emergentagent.com (UNAVAILABLE - Preview down)
- **URL Used:** https://production-bugfix-1.preview.emergentagent.com
...
3. The original URL (https://production-bugfix-1.preview.emergentagent.com) is unavailable
...
- OR test on the production URL mentioned in review request (https://production-bugfix-1.preview.emergentagent.com) when available
...
3. OR wait for https://production-bugfix-1.preview.emergentagent.com to be available
...
1. A working environment (https://production-bugfix-1.preview.emergentagent.com when available)
...
### Screenshots Captured
1. `01_login_page.png` - https://production-bugfix-1.preview.emergentagent.com showing "Preview Unavailable" error
...
2. ⚠️ **Testing Environment:** https://production-bugfix-1.preview.emergentagent.com is currently down
3. 📋 **Next Steps:**
...
// https://production-bugfix-1.preview.emergentagent.com/payment/success?session_id={CHECKOUT_SESSION_ID}
...
2. **Wake Up Preview Environment**
   ...
   - Restart the app at URL: https://production-bugfix-1.preview.emergentagent.com
