...
agent_communication:
  ...
  - agent: "testing"
    message: "Testing double participation bug fix according to review request. Will test: 1) Initial state with spinner, 2) Participation and refresh behavior, 3) Double participation prevention, 4) Leave and re-participate flow."
  - agent: "testing"
